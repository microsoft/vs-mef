...
namespace VS.Mefx.Commands
{
    ...
    internal class PartNode
    {
        ...
        /// </summary>
        internal ComposablePartDefinition Part { get; private set; } // Represents the part associated with the current node

        /// <summary>
        /// Gets the verbose rejection messages associated with the current part.
        /// </summary>
        internal HashSet<string> VerboseMessages { get; private set; } // Rejection Message(s) associated with the current part
        ...
        /// </summary>
        internal HashSet<PartEdge> ImportRejects { get; private set; }
        ...
        /// </summary>
        internal HashSet<PartEdge> RejectsCaused { get; private set; }
        ...
        internal void SetWhiteListed(bool value)
        {
