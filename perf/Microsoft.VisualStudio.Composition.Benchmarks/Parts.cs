...
namespace Microsoft.VisualStudio.Composition.Benchmarks
{
    ...
    public abstract class ProcessorBase : IProcessor
    {
        ...
        [MefV2.ImportMany] public IEnumerable<System.Lazy<IService, IServiceMetadata>> Services { get; set; }
    ...
    [MefV1.Export] public class ConsumerV1 { [MefV1.ImportMany] public IEnumerable<IServiceV1> Services { get; set; } }
}
